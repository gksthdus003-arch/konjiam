        ...
        >
          ...
          >
            ...
            {locations.map((location) => {
              ...
              const showLabel = isCurrent || mode === "all";
              return (
                <button
                  key={location.id}
                  type="button"
                ...
                >
                  ...
                  {showLabel ? (
                    <span
                      className={`mt-1 block max-w-32 rounded-md bg-white/95 px-2 py-1 text-[11px] font-black text-ink shadow-sm ring-1 ring-line ${
                        isCurrent ? "translate-x-[-38%] text-coral" : "translate-x-[-42%]"
                      }`}
                    >
                      {location.name}
                    </span>
